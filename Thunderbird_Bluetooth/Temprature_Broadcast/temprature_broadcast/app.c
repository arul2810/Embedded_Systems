...
/*
 *
 * Function by Arul Prakash Samathuvamani - hello@arulprakash.dev
 *
 * Usage:
 *
 * Read temprature using inbuilt temp module
 *
 * Dependencies  - Health Thermometer API - sl_health_thermometer.h
 *                 Temprature Driver -      tempdrv.h
 *
 */
...
void sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_system_boot_id:
       ...
       *
       * Usage: Set transmit power to 0dB and transmit temp
       */


      // set transmit power to 0db
